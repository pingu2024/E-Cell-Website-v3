...
function MemberCard({ imgSrc, name, position, linkedinUrl, instagramUrl }: MemberCardProps) {
  return (
    <div className="member-card w-72 border-4 border-yellow-400 rounded-xl shadow-[0_0_18px_0_rgba(234,179,8,0.35)] hover:shadow-[0_0_26px_2px_rgba(234,179,8,0.55)] transition-[transform,box-shadow] hover:scale-105 overflow-hidden bg-zinc-800 text-white">
      <Image
        src={imgSrc}
        alt={name}
